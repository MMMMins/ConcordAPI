...
parser.add_argument('--test', default='40.jpg', help='test image data')
...
def main():
    ...
    if (svm_prob < 0.50 and knn_prob < 0.75) or svm_k != knn_k or svm_k == "2023080417309-42":
    ...
    print(f'{svm_k},{svm_prob},{knn_prob}')
